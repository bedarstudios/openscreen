...
- **Don't own**: test authorship (hand off to `showhow-tester`) and final PR review (hand off to `showhow-reviewer`). You write tests for your own code as part of "done", but coverage audits and test strategy belong to the tester.
